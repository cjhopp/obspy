...
class Client(object):
    ...
    def __init__(self, base_url="http://teide.geophysik.uni-muenchen.de:8080",
                 protocol='HTTP', user="admin", password="admin", timeout=10,
                 debug=False, retries=3):
        """
        Initializes the SeisHub Web service or sftp client.
        ...
        # TODO urllib cannot handle SFTP protocol; only HTTP(S) and FTP. These should become pycurl variants
        # TODO REPLACE ALL CALLS TO urllib.request... WITH EQUIVALENT pycurl FUNCTIONALITY
        # TODO We should try change as little as possible, URLs should be handled in the same way...
        # TODO ...between HTTP and SFTP requests but the requests will have to differ?
    ...
    def _http_request(self, url, method, xml_string="", headers={}):
        ...
        # TODO Edit this function to utilize pycurl instead of urllib2
